                    ...
                    <View className="sub-details">
                        ...
                        <View className="sub-row">
                            <View className="sub-row-copy">
                                ...
                                <Text className="sub-value" numberOfLines={1}
                                      ellipsizeMode="tail">{startDate?.trim() ? formatSubscriptionDateTime(startDate.trim()) : ""}</Text>
                            </View>
                        </View>
                        <View className="sub-row">
                            <View className="sub-row-copy">
                                ...
                                <Text className="sub-value" numberOfLines={1}
                                      ellipsizeMode="tail">{renewalDate?.trim() ? formatSubscriptionDateTime(renewalDate.trim()) : ""}</Text>
                            </View>
                        </View>
                        <View className="sub-row">
                            <View className="sub-row-copy">
